...
class ErrorResponseDetail(BaseModel):
    ...
    details: Optional[Dict[str, Any]] = Field(default=None, description="Optional metadata or context details about the error")
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def app_exception_handler(request: Request, exc: AppException) -> JSONResponse:
        logger.warning(f"AppException occurred: {exc.code} - {exc.message} | Details: {exc.details}")
