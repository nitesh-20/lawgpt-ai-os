...
class ReadyResponse(BaseModel):
    ...
    services: dict = Field(..., examples=[{"firestore": "connected", "storage": "connected"}])
...
async def ready():
    ...
    firestore_status = "connected" if firestore_client is not None else "mocked/disconnected"
    storage_status = "connected" if storage_client is not None else "mocked/disconnected"
